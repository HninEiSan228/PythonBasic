...
$host='localhost';
    ...
    $query="update service set price=$price where description='dress' AND name='$name' ";
...
<body>
        <form action='updateDress1.php' method='post'>
     
        <label> Dress name &nbsp;&nbsp;&nbsp;</label><input type='text' name='name'><br><br>

        <label> Dress price (new)  &nbsp;&nbsp;&nbsp; </label><input type='text' name='price'> <br><br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            &nbsp;&nbsp;&nbsp;&nbsp;
