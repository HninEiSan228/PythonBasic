<?php
  $host='localhost';
    ...
    $query="update service set price=$price where description='gift' AND name='$name' ";
...
<body>
        <form action='updateGift1.php' method='post'>
     
        <label> Gift name &nbsp;&nbsp;&nbsp;</label><input type='text' name='name'><br><br>

        <label> Gift price (new)  &nbsp;&nbsp;&nbsp; </label><input type='text' name='price'> <br><br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            &nbsp;&nbsp;&nbsp;&nbsp;
