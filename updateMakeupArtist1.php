<?php
    ...
    $query="update service set price=$price where description='makeup' AND name='$name' ";
...
<body>
        <form action='updateMakeupArtist1.php' method='post'>
     
        <label> Makeup artist name &nbsp;&nbsp;&nbsp;</label><input type='text' name='name'><br><br>

        <label> Makeup artist price (new)  &nbsp;&nbsp;&nbsp; </label><input type='text' name='price'> <br><br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            &nbsp;&nbsp;&nbsp;&nbsp;
