<?php
    ...
    $query="update service set price=$price where description='photo' AND name='$name' ";
...
<body>                    
        <form action='updatePhotographer1.php' method='post'>
     
        <label> Photographer name &nbsp;&nbsp;&nbsp;</label><input type='text' name='name'><br><br>

        <label> Photographer price (new)  &nbsp;&nbsp;&nbsp; </label><input type='text' name='price'> <br><br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            &nbsp;&nbsp;&nbsp;&nbsp;
