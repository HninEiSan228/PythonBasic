<?php
    ...
    $query="update service set price=$price where description='venue' AND name='$name' ";
...
<body>
        <form action='updateVenue1.php' method='post'>
     
        <label> venue name &nbsp;&nbsp;&nbsp;</label><input type='text' name='name'><br><br>

        <label> venue price (new)  &nbsp;&nbsp;&nbsp; </label><input type='text' name='price'> <br><br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;            &nbsp;&nbsp;&nbsp;&nbsp;
